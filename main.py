...
st.write('''<br><left><font color = "#ff3814" size = 3>Aplikasi berikut menampilkan data tabel yang diimport dari data excel. Data yang disajikan memuat link, yang apabila di-click, akan menuju ke suatu alamat website</font><font color = "blue" style="background-color: #d0ff14"><a href = "https://github.com/gioprana89/2025_galeri_streamlit_datatabel2" target = '_blank' style = 'text-decoration:none'> Download Kode.</a></font>
